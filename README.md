* In this project we can "ADD" an item into a list.
* After adding the item it will comes under the todo list and after that with the help of checkbox we can select the item whatever we want to be deleted and we can "DELETYE" them.
